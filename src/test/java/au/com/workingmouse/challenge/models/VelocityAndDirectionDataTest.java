...
class VelocityAndDirectionDataTest {
	...
	void getDcsAbsSpdAvg() {
		//System.out.println("The velocity is " + velocityAndDirectionData.getDcsAbsspdAvg());
	...
	@Test
	void getDcsSpStdAvg() {
		// System.out.println("DcsSpStdAvg is " + velocityAndDirectionData.getDcsSpStdAvg());
		//assertEquals( "yolo", velocityAndDirectionData.getDcsSpStdAvg()); 4.367773
