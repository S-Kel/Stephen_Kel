...
public class VelocityAndDirectionService {
    ...
    public static List<VelocityAndDirectionData> parseLines(List<String> lines) {
       ...
       // System.out.println("Lines:> Size: " + lines.size() + " >" + lines);
...
//        var lines = parseLines(velocityAndDirectionDataset);
        //System.out.println("totalLines=====>" + totalLines + " " + velocityAndDirectionDataset.toArray()[0]);
//        for (int i = 0; i < velocityAndDirectionDataset.size(); i++) {
//            System.out.println("List Item: " + velocityAndDirectionDataset.get(i));
//        }

        double sum =0;
        var data = new String[ velocityAndDirectionDataset.size()];
        data = data=velocityAndDirectionDataset.toString().split("()");

        /*
        for (int i = 0; i < velocityAndDirectionDataset.size(); i++) {
            data=velocityAndDirectionDataset.toArray()[i].toString().split(",");
        }
